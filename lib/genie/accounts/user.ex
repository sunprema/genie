  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender Genie.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource Genie.Accounts.Token
      signing_secret Genie.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender Genie.Accounts.User.Senders.SendPasswordResetEmail
