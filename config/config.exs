...
config :genie, GenieWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: GenieWeb.ErrorHTML, json: GenieWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Genie.PubSub,
  live_view: [signing_salt: "vyyfudEQ"]
...
config :genie, Genie.Mailer, adapter: Swoosh.Adapters.Local
